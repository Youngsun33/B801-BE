...
async function fixTutorialStory() {
  try {
    console.log('🎮 올바른 튜토리얼 스토리로 수정 시작...');
    ...
    const tutorialNodes = [
      ...
      },
      {
        ...
        route_name: "tutorial",
        choices: JSON.stringify([
          { id: 3, targetNodeId: 4, label: "빠르게 요약 좀 해 주시겠어요?" },
          { id: 4, targetNodeId: 4, label: "이미 알고 있는 이야기니 빠르게 갑시다." }
        ]),
        rewards: null,
        position_x: 200,
        position_y: 100
      },
      {
        node_id: 3,
        title: "빠른 진행",
        text: "이미 알고 있는 이야기니 빠르게 갑시다.",
        node_type: "main",
        route_name: "tutorial",
        choices: JSON.stringify([
          { id: 5, targetNodeId: 4, label: "계속" }
        ]),
        rewards: null,
        position_x: 200,
        position_y: 200
      },
      {
        ...
        route_name: "tutorial",
        choices: JSON.stringify([
          { id: 6, targetNodeId: 5, label: "지금 나는 어떤 상태죠?" }
        ]),
        rewards: null,
        position_x: 300,
        position_y: 150
      },
      {
        ...
        route_name: "tutorial",
        choices: JSON.stringify([
          { id: 7, targetNodeId: 6, label: "그렇군요. 이제 출발하죠." }
        ]),
      ...
      },
      {
        ...
        route_name: "tutorial",
        choices: JSON.stringify([
          { id: 8, targetNodeId: 300, label: "정말 출발합시다." }
        ]),
    ...
    console.log('🎉 올바른 튜토리얼 스토리 수정 완료!');
    console.log('  - 튜토리얼 노드: 6개 (노드 1-6)');
    console.log('  - 선택지: 8개');
    console.log('  - 플로우: 시작 → 핵전쟁 설명 → 상태 확인 → 능력 배부 → 김필일 도움 → 세 갈래 길 (노드 300)');

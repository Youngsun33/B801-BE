...
router.get('/users/:id', adminController_1.getAdminUserDetail);
...
router.put('/users/:id/investigation-count', adminController_1.updateUserInvestigationCount);
router.post('/users/:id/items', adminController_1.addUserItem);
router.post('/users/:id/abilities', adminController_1.addUserAbility);
router.delete('/users/resources/:resourceId', adminController_1.deleteUserResource);

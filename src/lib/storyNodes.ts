...
// 선택에 따른 다음 노드 매핑
export const CHOICE_TO_NODE: Record<number, number | string> = {
  // 인트로 (100번대)
  100: 101,  // 핵전쟁 상세 설명
  101: 102,  // 빠르게 가기
  102: 200,  // 요약 → 능력 부여
  103: 200,  // 빠르게 가기 → 능력 부여
  104: 200,  // 지금 상태 → 능력 부여
  
  // 능력 부여 (200번대)
  2001: 209,  // 능력 부여 → 권총 설명
  2091: 210,  // 권총 설명 → 출발
  2101: 300,  // 출발 → 체크포인트 1
  
  // 체크포인트 1 - 세 갈래 길 (300번대)
  3001: 'MAIN_STORY_ROUTE_1',  // 왼쪽 길 → 메인 스토리 "루트 1"
  3002: 'MAIN_STORY_ROUTE_2',  // 가운데 길 → 메인 스토리 "루트 2"
  3003: 'MAIN_STORY_ROUTE_3',  // 오른쪽 길 → 메인 스토리 "루트 3"
...
// 랜덤 스토리 풀 (추가 랜덤 이벤트들)
export const RANDOM_STORY_POOL = [1002, 1003, 1004, 1005, 1006, 1010, 1011, 1012, 1013, 1014];

// 메인 스토리 풀
export const MAIN_STORY_POOL = [1007, 1008, 1009, 1015, 1016, 1017];

// 체크포인트 노드들
export const CHECKPOINT_NODES = [1001, 1018, 300];

// 인트로 노드들
export const INTRO_NODES = [100, 101, 102];

// 튜토리얼 노드들 (능력 부여)
export const TUTORIAL_NODES = [200, 209, 210];
